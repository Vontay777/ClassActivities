...
const task6 = data.filter(task => task.userId == 6);
console.log(task6);

// filter for user 8 incomplete task

const task6uncomplete = task6.filter(task => task.completed != true);
console.log(task6uncomplete);
